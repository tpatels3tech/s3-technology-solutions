...
export default function Services() {
  return (
    <>
      <Section>
        <Container>
          <div className="text-xs font-semibold tracking-[0.28em] text-slate-300">SERVICES</div>
        ...
        <Container>
            ...
            <Card>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-xl shadow-[0_18px_55px_-40px_rgba(0,0,0,0.8)]">
                  ...
                  <ul className="mt-3 list-disc space-y-2 pl-5 text-base text-slate-200">
          ...
          <div className="mt-12 flex flex-col items-start justify-between gap-5 rounded-3xl border border-white/10 bg-white/[0.04] p-7 backdrop-blur-xl md:flex-row md:items-center">
            <div>
              ...
              <div className="mt-1 text-base text-slate-200">Book a short call and we’ll map the quickest path to value.</div>
            </div>
